            ...
            <div className="container mx-auto px-4 lg:px-16">
                ...
                <div className="text-center mb-10 max-w-3xl mx-auto">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#003ECB]/5 border border-[#003ECB]/10 mb-6"
                    >
                        <LuSparkles className="text-[#003ECB]" size={16} />
                        <span className="text-[10px] font-bold text-[#003ECB] uppercase tracking-[0.2em]">
                    ...
                    <motion.h2
                        ...
                        className={`text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-[#003ECB] mb-4 ${bengaliClass}`}
                    >
                        {language === 'bn' ? 'ডিজিটাল অ্যাসেটস' : 'Digital Assets'}
                    </motion.h2>

        ...
        <section className="py-16 bg-[#efefef] dark:bg-[#050505] overflow-hidden">
            <div className="container mx-auto px-4 lg:px-16">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    >
                        <h2 className={`text-3xl md:text-4xl lg:text-5xl font-heading font-black text-[#003ECB] mb-6 ${bengaliClass}`}>
                        ...
                        <div className={`space-y-4 text-slate-700 dark:text-slate-400 text-sm md:text-base leading-relaxed ${bengaliClass}`}>
                            <p>
                                {language === 'bn'
                                    ? 'আবু সাঈদ একজন অভিজ্ঞ গ্রাফিক এবং ইউএক্স/ইউআই ডিজাইন নির্দেশক, যার রয়েছে ২০ বছরেরও বেশি সময়ের পেশাদার অভিজ্ঞতা। বর্তমানে তিনি BITM এবং UIU (IBER)-এর মতো স্বনামধন্য প্রতিষ্ঠানে ডিজাইন প্রশিক্ষক হিসেবে কাজ করছেন।'
                                    : 'Abu Sayeed is a seasoned Graphic and UX/UI Design instructor with over 20 years of professional experience. He currently leads design training programs at BITM and UIU (IBER), sharing his vast industry expertise with aspiring designers.'}
                            </p>
                        ...
                        <div className="flex gap-4 mt-10">
                            {socialLinks.map((social, index) => (
                                <a
                                    ...
                                    className="w-10 h-10 rounded-full bg-white dark:bg-white/5 flex items-center justify-center text-slate-600 dark:text-white border border-slate-200 dark:border-white/10 hover:bg-[#003ECB] hover:text-white hover:border-[#003ECB] transition-all duration-300 shadow-sm"
                                >
                                    {social.icon}
                                </a>
                            ))}
                    ...
                    >
                        <div className="relative w-full max-w-lg aspect-[4/5] md:aspect-square mx-auto">
                            ...
                            <div className="absolute top-10 right-10 w-3/4 h-3/4 bg-[#003ECB]/5 rounded-[40px] rotate-6 z-0" />
                            ...
                            {/* Experience Badge */}
                            <div className="absolute top-10 left-0 -translate-x-1/4 bg-[#003ECB] text-[#D4AF37] p-4 md:p-6 rounded-full shadow-2xl z-40 flex flex-col items-center justify-center w-24 h-24 md:w-32 md:h-32 border-4 border-white dark:border-[#050505] animate-bounce-slow">
                                <span className="text-2xl md:text-3xl font-black font-heading leading-none">20+</span>
                            ...
                            <div className="absolute -top-6 -right-6 w-32 h-32 bg-[#003ECB]/5 rounded-full blur-3xl"></div>
                        </div>
                    </motion.div>
